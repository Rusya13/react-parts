...
export class Upload extends React.Component{
        ...
        if (this.fileInput && this.fileInput.files.length > 0){
            ...
            for (let i = 0 ; i < this.fileInput.files.length; i ++){
                list.push(<div className="reactParts__upload--file" key={i}>
                    <svg className="reactParts__upload--file-icon" xmlns="http://www.w3.org/2000/svg" fill="#000000" height="15" viewBox="0 0 24 24" width="15">
    ...
    render(){
        return(
            <div>
                <Button caption={this.props.caption} brand={this.props.brand} onClick={this.onClick}/>
                <input
                    style={{display:"none"}}
